...
INTERAKT_API_KEY=$(get_env_var "INTERAKT_API_KEY")
INTERAKT_WEBHOOK_SECRET=$(get_env_var "INTERAKT_WEBHOOK_SECRET")
ALLOWLIST_NUMBERS=$(get_env_var "ALLOWLIST_NUMBERS")
BOT_ENABLED=$(get_env_var "BOT_ENABLED")
